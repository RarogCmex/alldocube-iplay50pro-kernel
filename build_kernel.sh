...
export PATH=${RDIR}/../alldocube-toolchain/clang-r416183b/bin:$PATH
export BUILD_CROSS_COMPILE="${RDIR}/../alldocube-toolchain/arm-gnu-toolchain-14.2.rel1-x86_64-aarch64-none-linux-gnu/bin/aarch64-none-linux-gnu-"
...
echo -e "CONFIG_LOCALVERSION_AUTO=n\nCONFIG_LOCALVERSION=\"-rarogcmex-${BUILD_KERNEL_VERSION}\"\n" > "${RDIR}/arch/arm64/configs/version.config"
